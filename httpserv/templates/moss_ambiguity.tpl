...
In a world in which the primary economic horizon is one of war in its various modalities, including  conflict with the irreducible other, the perpetual struggle of all against all or asymmetric warfare, the kind of practical criticism traditionally carried out by intelligence and counter-intelligence operatives becomes a vital necessity. The surprise conjunction of literary criticism and geo-political strategising represented by the Cold War intelligence practices at senior levels of the CIA and its forerunners, allowed for an attentiveness to and cultivation of ambiguity that presented an invaluable means for monitoring, evaluating, manipulating and deceiving the other. Ambiguity and the mental conflict it discloses  - or, indeed, creates is at once a diagnostic tool, to the extent that it systematizes potentially antagonistic or threatening intentions, and a critical weapon to the extent that it creates doubts, uncertainties and the possibilities for divergences in the field of action in which it is at work. For the assiduous operative holed up in an office in Langley, in Ludovisi in Rome or in St James's in London, applying the same scrupulous attention to textual detail and the nuances of phrase in a covert operation such as HT/Lingual as would once have been applied to a reading of a poem by Ezra Pound or a letter composed to ee cummings appears as a geopolitical imperative and defense of imperiled imperial values.
    ...
    <div class="note_donatella">
	<p>See Michael Holzman, <em>James Jesus Angleton. The CIA and the Craft of Counterintelligence</em> (Amhert: Massachusetts University Press, 2008) <a href="http://books.google.com/books?id=H8q_zVR_5EYC&printsec=frontcover">http://books.google.com/books?id=H8q_zVR_5EYC&printsec=frontcover</a></p>
	<p>Holzman offers some new information on Angleton’s personal life and poetic interests, but his recounting of Angleton’s intelligence career follows the usual well-worn tracks. He does, however, give the earlier years their due instead of hurtling into the 1960s like most other writers. Holzman’s research is reasonably thorough, but for a literary critic he uses secondary sources with a surprisingly unquestioning attitude, and he makes many careless mistakes with dates, organizations, and people. The narrative is cluttered with several pedantic or politically loaded asides and digressions into CIA and FBI activities that Angleton was aware of but not directly involved in, such as anti-Castro plots and COINTELPRO. The extensive treatment of MHCHAOS repeats much of what has been known since the Church Committee report of 1976 and serves as a set piece for Holzman to express his moral outrage at the “STASI-like mentality” (44) behind the US government’s post-9/11 counterterrorism and internal security measures. <a href="https://www.cia.gov/library/center-for-the-study-of-intelligence/csi-publications/csi-studies/studies/vol53no4/201ccunning-passages-contrived-corridors201d.html">https://www.cia.gov/library/center-for-the-study-of-intelligence/csi-publications/csi-studies/studies/vol53no4/201ccunning-passages-contrived-corridors201d.html</a></p>
    </div>
...
The movement is from the document to the text and from there, through close reading, to the other and their intentions. With suitably muted ambiguity, Empson argued that the fundamental situation, whether it deserves to be called ambiguous or not, is that a word or a grammatical structure is effective in several ways at once”.
    ...
    <p class="insertion">
In analyzing the statement made by a sentence (having, no doubt, fixed on the statement by an apprehension of the implications of the sentence), one would continually be dealing with a sort of ambiguity due to metaphors, made clear by Mr. Herbert Read in <em>English Prose Style</em> ; because metaphor, more or less taken for granted (so as to be unconscious), is the normal mode of development of a language. 'Words used as epithets are words used to analyze a direct statement,' whereas 'metaphor is the synthesis of several units of observation into one commanding image; it is the expression of a complex idea, not by analysis, nor by direct statement, but by a sudden perception of an objective relation'. One thing is said to be like another, and they have several different properties in virtue of which they are alike. 
    </p>
    <div class="note_donatella">
        <p>William Empson, <em>The Seven Types of Ambiguity</em> 2<sup>nd</sup> Edition (London, Chatto and Windus, 1949) p.2. <a href="http://ia600308.us.archive.org/32/items/seventypesofambi030525mbp/seventypesofambi030525mbp.pdf">http://ia600308.us.archive.org/32/items/seventypesofambi030525mbp/seventypesofambi030525mbp.pdf</a></p>
    </div>
    <p class="ambiguity">
Acknowledging the claims of his critics, that almost anything could be considered ambiguous given the expansive understanding of the notion that <em>The Seven Types of Ambiguity</em> exhibits, Empson defends his position by arguing for the [something about scientific certainties]. Incipit New Criticism and the strategy of close reading. Incipit equally James Jesus Angleton and the newly minted position of the CIA's Head of Counter-Intelligence.
    </p>
    <p class="insertion">
...
<div class="note_donatella">
<p>
<a href="http://entertainment.timesonline.co.uk/tol/arts_and_entertainment/the_tls/article6469054.ece">
http://entertainment.timesonline.co.uk/tol/arts_and_entertainment/the_tls/article6469054.ece</a>
</p>
</div>
<p class="ambiguity">
...
<p class="insertion">
And no less than the form of the personal, the transcendental field of sense must exclude the form of the general and the form of the individual. For the first characterizes only a subject which <em>manifest</em> itself; but the second characterizes only objective classes and properties which are <em>signified</em>; and the third characterizes only denotable systems which are <em>individuated</em> in an objective manner, referring to subjective points of view which are themselves <em>individuating</em> and <em>designating</em>.    
</p>
<div class="note_donatella">
<p>
Gilles Deleuze, <em>The Logic of Sense</em>, p.114
<a href="http://books.google.com/books?id=PKfBPrRda4sC&printsec=frontcover">
http://books.google.com/books?id=PKfBPrRda4sC&printsec=frontcover</a>
</p>
</div>
<p class="ambiguity">
But far from reducing the opportunities for manipulation and deception, the new situation of systemic ambiguity opens up and extends the scope of counter-intelligence operations for the astute media operative. Of course, under such circumstances, maintaining the prerogatives of a dominant imperial center  becomes a considerable challenge, which is perhaps one reason to be thankful that many of the tools and techniques for detecting and tracking the  ambiguities that portend mental conflict <em>and</em> social antagonism<a rel="note" href="#">NOTE</a> can be provisionally conferred on the algorithms and data structures of dataveillance and forensic computing technologies. Notwithstanding, in a period in which it is difficult to trace patterns of conflict and the emergence of antagonisms back to a single binary opposition with any degree of plausibility, the gray zones of gray media call for  new forms of investigation and a more nuanced approach to the kinds of tensions and patterns of interference that arise. If the operatives of the cold war could reserve for themselves the position of <em>l'éminence grise</em>, the distant advisor to the executive power, the new spaces of collectively intelligent networks and the asymmetrical relations these put in place demand instead the more difficult position of <em>l'immanence grise</em>.
</p>
<div class="note_donatella">
<p>
A specific characteristic of the systemic ambiguity whose mise en stratageme we are mapping out here is that it is the expression of an <em>objective indeterminacy</em>. Ambiguity is not the merely subjective form of mental conflict, as it is in Empson. See Deleuze <em>ibid</em> and equally Gilles Deleuze, <em>The Fold: Leibniz and the Baroque</em>, where the ambiguous sign is linked to Henry James as much as to Leibniz.
</p>
</div>
...
<p class="ambiguity">
Somewhat late in the day, management theory discovered that within organizations, ambiguity can have a useful strategic function. As a 'strategy in organizational communication', ambiguity fosters 'unified diversity' (what the Ancient Greeks would have called homonia we don't agree but it sounds like we do), maintains positions of privilege, promotes plausible deniability and facilitates organizational change. Now, quite aside from giving the scheming executive an efficiency-based rationale for his or her power games and the invaluable addition of an extra equivocation in his or her action  (a point that is not usually considered in communication and organization theory), management theory focus somewhat exclusively on verbal (written and oral) communication, precluding a more complete appreciation of colours in the operative's palette.<a href="#">NOTE</a>  Indeed, the research focus on linguistic communication can itself have useful strategic outcomes, since it removes attention from the shifting environment in which that communication operates.<a href="#">NOTE</a>
</p>
<div class="note_donatella">
<p>
Typically, consideration is given to 'symbolic action'. See Eisenberg <em>ibid</em>.
</p
<p>
But by the end of the 1980s, a rapidly growing body of action-oriented research had emerg. The core constructs of this actionist cluster are <em>culture</em>, <em>meaning/messages</em>, <em>symbolism</em> and  <em>ambiguity</em>. Some applications of his cluster focus on the ways in which organizational communication practices and cultural artifacts articulate and reflect the shared meanings of a social collective (Cheney & Vibbert, 1987; Smirch & Calas, 1987; Triandis & Albert, 1987). Others examine the processes through which meanings become shared and cultures and subcultures are formed and sustained through symbolic action (Eisenberg & Riley, 1988; Huber & Daft, 1987; Krone et al., 1987; Tompkins, 1987).
<a href="http://books.google.com/books?id=6fumvnF6BsEC&pg=PA55&lpg=PA55&dq=symbolic+action+eisenberg&source=bl&ots=E2JAp_5F-y&sig=Vi4ltYtGBMS2xDDpErH5yJT1D_k&hl=en&ei=ilzJTenQNMqDOuDs9eEH&sa=X&oi=book_result&ct=result&resnum=1&sqi=2&ved=0CBUQ6AEwAA#v=onepage&q=symbolic%20action%20eisenberg&f=false">
http://books.google.com/books?id=6fumvnF6BsEC&pg=PA55&lpg=PA55&dq=symbolic+action+eisenberg&source=bl&ots=E2JAp_5F-y&sig=Vi4ltYtGBMS2xDDpErH5yJT1D_k&hl=en&ei=ilzJTenQNMqDOuDs9eEH&sa=X&oi=book_result&ct=result&resnum=1&sqi=2&ved=0CBUQ6AEwAA#v=onepage&q=symbolic%20action%20eisenberg&f=false</a>
</p>
</div>
<div class="note_donatella">
<p>
