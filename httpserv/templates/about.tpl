...
<p>
This publication documents the 12th edition of the Verbindigen/Jonctions
festival which took place in Brussels from 21 to 29 November 2009. 
</p>
<p>
This bi-annual multidisciplinary festival is organized by Constant, association
for art and media, with the intent to gather around the same table a large and
diverse public - radio makers, artists, software programmers, academics, Linux
users, interface designers, urban explorers, performance artists, technicians,
lawyers and others – and to offer them the chance of experiencing each other’s
practices and experimental reflections on technological culture and free
licenses.  This edition was hosted at 17 rue de la Senne, in an open public
space that Constant was invited to share with other organizations as part of
the one-year program implemented by Ischa Tallieu and Jan Verbruggen with the
intention of enhancing an abandoned building in the heart of Brussels. 
</p>
<p>

Through a series of conferences, work sessions and performances, three topics
of discussion were proposed and explored:
</p>
<p>

Shades of Grey Literature was an invitation to discover, play and worry
about the mass of anonymous documents, commentaries and written traces
which form the background    of electronic and non-electronic
communication; as it frames the relationship between machines and humans
and the way humans relate through networks, who has the right to see, read,
write or execute?
</p>
<p>

The Life and Nature of Data tried to answer the question: what is a data? To
who or what it is handed over or where does it come from? Each electronic
transaction leaves a trace; profiling of users is done in the interest of
marketeers and advertisers, for state surveillance or to control the workplace;
different practices all based on the extraction of information from “data”, an
ambiguous entity always ready to mutate, multiply and never loyal to
its origins.
</p>
<p>

Performative Instructions analysed codes and norms that put themselves or
others in motion. Users and developers exchange information through bug reports
and error messages and confront issues of responsibility and authority put in
place through manuals, recipes, forms and other types of instructions.
</p>
<p>

During the festival, the interventions varied from lectures discussing the
ambiguity concealed in the Web language and in its abundant grey literature
(Systemic ambiguity by Andrew Goffey and Matthew Füller, To talk of many things
by Michael Moss) to a surgical analysis of the textual codes and standards of
the Debian community (From source code to text code by Christophe Lazaro); from
a Soap box annual report (by Ivan Monroy Lopez) to an on-line conversation
about FLOSS manuals and practices (Fit for purpose); from a trans-disciplinary
collaborative installation-performance around the usage of surveillance
camera’s and softwares (Kaleidoscope by An Mertens) to a conference weighing
the value and the appeal of privacy nowadays (Amidst the Golden Age of Privacy
by Seda Gürses); from a philosophical and socio-anthropological theater
adventure (Smatch(1) by Dominique Roodthooft) to a time-travel into the land of
the paratext (From textual scholarship to the study of tradition by  Jurgen
Pieters) to a presentation of new applications and platforms on Internet
(GooDiff by Alexandre Delaunoy, Epicpedia by Annemieke and Marloes Van Der
Hoek).
</p>
<p>

The three topics mentioned above and the different ways they were developed by
the participants inspired us with the idea of a publication that brakes with
the tradition of the printed catalog and responds instead to different criteria
imposed by the very nature of the Web and to the possibilities opened up by the
new media in terms of writing/editing a text or a book. 
</p>

<h2>The inspirational sources</h2>

<h3>Text vs Document</h3>
