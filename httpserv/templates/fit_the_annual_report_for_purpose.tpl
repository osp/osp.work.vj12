    ...
    <div id="container">
        ...
        <p class="line">
            ...
            <ul style="margin-bottom: 1.3em;">
                <li class="username">IVAN, <em style="font-style: italic; letter-spacing: 0; text-transform: lowercase">the voice-over</em></li>
